...
```bash
npm install @rneui/themed @react-native-seedui
```
...
```bash
yarn add @rneui/themed @react-native-seedui
```
...
```bash
npm install @react-native-seedui@edge @rneui/themed@edge
```
...
```bash
yarn add @react-native-seedui@edge @rneui/themed@edge
```
...
```bash
# @react-native-seedui
yarn add @react-native-seedui@github:react-native-elements/react-native-elements#base
...
Create a new project with Expo CLI and Seed UI template
...
```bash
yarn add  @react-native-seedui @rneui/themed react-native-web react-native-vector-icons
```
...
module.exports = override(
  ...
  babelInclude([
    path.resolve(__dirname, 'node_modules/@react-native-seedui'),
